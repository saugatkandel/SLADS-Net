...
#    Theta=np.transpose(np.load(ThetaLoadPath +'Theta.npy'))
    ...
    SimulationRun = 1
    ImNum = 1
    runSLADSSimulationOnce(Mask,CodePath,TestingImageSet,SizeImage,StopCondParams,Theta,TrainingInfo,Resolution,ImageType,UpdateERDParams,BatchSamplingParams,SavePath,SimulationRun,ImNum,ImageExtension,PlotResult,Classify)
